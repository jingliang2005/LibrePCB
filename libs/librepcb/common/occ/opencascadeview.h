...
#ifndef LIBREPCB_OPENCASCADEVIEW_H
#define LIBREPCB_OPENCASCADEVIEW_H
...
/**
 * @brief The OpenCascadeView class
 */
class OpenCascadeView final : public QGLWidget {
  Q_OBJECT
...
public:
  ...
  OpenCascadeView(const OpenCascadeView& other) = delete;
  explicit OpenCascadeView(QWidget* parent = nullptr) noexcept;
  ~OpenCascadeView() noexcept;
...
#endif  // LIBREPCB_OPENCASCADEVIEW_H
